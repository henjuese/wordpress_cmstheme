...
<div id="gongaobox"><div id="gongao">当前位置：<a href="<?php bloginfo('siteurl'); ?>/" title="返回首页">首页</a> > <?php the_title(); ?></div>
...
<h2><?php the_title(); ?></h2>
<div class="hr"></div>
<div class="single_content"><strong><?php bloginfo('name'); ?></strong>目前共有文章：<?php echo $hacklog_archives->PostCount();?>篇
                <?php echo $hacklog_archives->PostList();?></div></div>
</div><?php endwhile; ?>
        <?php endif; ?>
<?php get_sidebar(); ?></div>
<div class="clear"></div>
